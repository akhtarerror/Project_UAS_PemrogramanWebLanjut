...
<head>
    ...
    <title>Detail Mahasiswa D4 Teknik Informatika</title>
...
<body>
    ...
    $queryMahasiswa = "SELECT * FROM mahasiswa WHERE prodi_mahasiswa = 'D4-Teknik Informatika'";
    ...
    <main class="table" id="customers_table">
        <section class="table__header">
            <h1>Detail Mahasiswa D4 Teknik Informatika</h1>

            <!-- Change the onclick attribute to open a new window with ti_print.php -->
            <button class="print" onclick="window.open('ti_print.php', '_blank')">Print</button>
        </section>
