...
<head>
    ...
    <title>Detail Mahasiswa D4 Teknik Multimedia Digital</title>
...
<body>
    <?php
    // Fetch data from the 'mahasiswa' table where prodi_mahasiswa is 'D4-Teknik Multimedia Digital'
    include 'koneksi.php';

    $queryMahasiswa = "SELECT * FROM mahasiswa WHERE prodi_mahasiswa = 'D4-Teknik Multimedia Digital'";
    ...
    <main class="table" id="customers_table">
        <section class="table__header">
            <h1>Detail Mahasiswa D4 Teknik Multimedia Digital</h1>

            <!-- Change the onclick attribute to open a new window with ti_print.php -->
            <button class="print" onclick="window.open('tmd_print.php', '_blank')">Print</button>
        </section>
