...
<head>
    ...
    <title>Print - Detail Mahasiswa D1 Teknik Komputer dan Jaringan</title>
    <style>
        body {
            font-size: 10pt;
            text-align: center;
...
<body>
    <?php
    // Fetch data from the 'mahasiswa' table where prodi_mahasiswa is 'D4-Teknik Komputer dan Jaringan'
    include 'koneksi.php';
