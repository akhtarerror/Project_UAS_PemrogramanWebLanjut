...
<head>
    ...
    <title>Detail Mahasiswa D1 Teknik Komputer dan Jaringan</title>
...
<body>
    <?php
    // Fetch data from the 'mahasiswa' table where prodi_mahasiswa is 'D-1 Teknik Komputer dan Jaringan'
    include 'koneksi.php';

    $queryMahasiswa = "SELECT * FROM mahasiswa WHERE prodi_mahasiswa = 'D1-Teknik Komputer dan Jaringan'";
    ...
    <main class="table" id="customers_table">
        <section class="table__header">
            <h1>Detail Mahasiswa D1 Teknik Komputer dan Jaringan</h1>

            <!-- Change the onclick attribute to open a new window with ti_print.php -->
            <button class="print" onclick="window.open('tkj_print.php', '_blank')">Print</button>
        </section>
