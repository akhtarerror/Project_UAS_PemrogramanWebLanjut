...
<head>
    ...
    <title>Detail Mahasiswa D4 Teknik Multimedia dan Jaringan</title>
...
<body>
    <?php
    // Fetch data from the 'mahasiswa' table where prodi_mahasiswa is 'D4-Teknik Multimedia dan Jaringan'
    include 'koneksi.php';

    $queryMahasiswa = "SELECT * FROM mahasiswa WHERE prodi_mahasiswa = 'D4-Teknik Multimedia dan Jaringan'";
    ...
    <main class="table" id="customers_table">
        <section class="table__header">
            <h1>D4 Teknik Multimedia dan Jaringan</h1>

            <!-- Change the onclick attribute to open a new window with ti_print.php -->
            <button class="print" onclick="window.open('tmj_print.php', '_blank')">Print</button>
        </section>
